...
Quindi riportando le misure in un grafico semi-logaritmico, come in \autoref{fig:onda quadra pendenze}, ci si aspetta di ottenere una funzione lineare
...
%qualcosa sulla funzione di trasferimento ottenuta?
